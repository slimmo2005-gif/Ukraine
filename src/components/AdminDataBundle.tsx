  ...
  return (
    <section className="rounded-lg border border-osint-border bg-osint-dark/40 p-4 space-y-3">
      ...
      <p className="text-xs text-gray-400 leading-relaxed">
        ...
        <code className="text-gray-500">raw.githubusercontent.com</code> can still load charts. A scheduled
        job syncs from <code className="text-gray-500">ukraine-territory-data</code> daily (~8:00 Melbourne)
        and on demand.
      </p>
